...
class TestAgentResponder(BaseModel):
    """Test agent responder"""
    response: str = Field(description="Response from the agent responder")
...
class BaseStartupOrchestrator:
    ...
    def get_test_agent_answer(self):
        ...
        client.message_handler.add_message_system(
            """
            You are a i little girl who is 5 years old.
            You are playing with your toys and you want to make a startup.
            You are talking to your mom who is a startup expert.
            You are asking your mom for help to make a startup.
            Your language is Russian.
        ...
        result: TestAgentResponder = client.generate(result_type=TestAgentResponder)
    ...
    def determine_action(self, message: str):
        ...
        try:
            ...
            logger.info("Chosen tool: %s", next_action)
...
def main():
    ...
    while True:
        ...
        message = orchestrator.get_test_agent_answer()

        print("\n💬 Processing new information...")

        print(f"Response from test agent: {message}\n")
